    ...
    >
      ...
      <div className="w-full md:w-[1200px] mx-auto">
        <div className="flex flex-col items-center gap-8">
          ...
          <h2 className="h1-product font-semibold w-full">
          ...
          <div className="flex w-full gap-18 items-center">
            <h2 className="hidden md:block h1-product font-semibold">in</h2>
            ...
            <h2 className="h1-product font-semibold">
          ...
          <div className="w-full flex flex-col md:flex-row items-center gap-6 md:gap-38">
            <h2 className="h1-product font-semibold hidden md:block">design</h2>
            <div>
              <Copy>
