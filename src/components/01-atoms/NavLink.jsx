...
export default function AppLink({
  ...
  //  ${underlineColor}
  //   origin-left transform transition-transform duration-500 ${isActive ? "scale-x-100" : "scale-x-0"} group-hover:scale-x-100 group-focus:scale-x-100`
  //   : "";

  const base = `relative group text-base ${extrabold ? "font-extrabold" : bold ? "font-bold" : ""} ${navColor} ${className}`;
  const underlineClass = underline //
